...
const initialAnalysis = {
  ...
  skillGap: ['Flask API Design', 'System Design'],
  recommendation: [
    'Build one end-to-end project',
    'Learn relational database basics',
    'Deploy the project with a public frontend and backend URL'
  ],
  confidence: 0.72
};
...
function App() {
  ...
  const handleUpload = async (event) => {
    ...
    setIsUploading(true);
    setStatusMessage('Analyzing CV through the Flask API...');
    ...
    <div className="shell">
      <header className="hero">
        <div className="hero-copy">
          ...
          <p>
            This starter uses Vite, React, Axios, Flask, and SQLAlchemy-ready persistence so the
            full-stack flow can move first while AI and DS are still preparing their parts.
          </p>
        ...
        <aside className="mockup-card">
          <div className="mockup-header">
            ...
            <span className="pill">Flask + React</span>
          </div>
      ...
      <main className="content-grid">
        <section className="panel upload-panel">
          <div className="panel-heading">
            ...
            <p>Multipart POST to <code>/api/cv/upload</code> handled by Flask.</p>
          </div>
        ...
        <section className="panel dashboard-panel">
          <div className="panel-heading">
            ...
            <p>Fetched from Flask via Axios.</p>
          </div>
